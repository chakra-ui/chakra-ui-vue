...
<SEO
  title="ControlBox"
  description="ControlBox provides style props to change it's styles based on a sibling checkbox or radio inputs. It relies on a common CSS technique for styling custom controls."
/>
