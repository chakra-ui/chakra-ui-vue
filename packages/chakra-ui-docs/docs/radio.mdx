...
<template>
  <c-radio-group v-model="selected">
    <c-radio value="1">First</c-radio>
    <c-radio value="2">Second</c-radio>
    <c-radio value="3">Third</c-radio>
  </c-radio-group>
</template>
...
<c-stack>
  ...
  <c-radio size="lg" name="1" variant-color="orange" default-checked>
    Radio
  </c-radio>
</c-stack>
```
...
<template>
  <c-stack>
    <c-radio-group v-model="selected" is-inline>
      <c-radio value="1" is-disabled>Disabled</c-radio>
      <c-radio value="2">Unchecked</c-radio>
      <c-radio value="3">Unchecked</c-radio>
    </c-radio-group>
