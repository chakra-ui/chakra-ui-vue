...
import { useMenuItemStyle } from './menu.styles'
import Box from '../Box'
  ...
  render (h) {
    ...
    if (!this.$slots || !this.$slots.default) {
      ...
      if (!this.$slots.default.length) {
        return console.error('[Chakra-ui]: <MenuOptionGroup /> component expects at least one child node.')
      }
    }
    ...
    const clonedChildNodes = children.map(vnode => {
      ...
      if (!cloned.componentOptions) return console.error('Chakra-ui: <MenuOptionGroup /> component expects valid component as children')
